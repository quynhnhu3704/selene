        ...
        <aside className="support-conversations">
          <div className="p-3 border-bottom">
            ...
            <button
              ...
              onClick={() =>
                open ? setSelectedId(open.conversation_id) : start()
              }
            >
            ...
            {conversations.map((item) => (
              ...
              >
                <div className="d-flex justify-content-between align-items-center">
                  <strong>Selene Support</strong>
                  {Number(item.customer_unread) > 0 && (
                    <span className="support-unread">
                      {item.customer_unread}
                    </span>
                  )}
                </div>
                <div className="support-preview">
                  {item.last_message || "Bạn cần Selene giúp gì?"}
                </div>
  ...
  return (
    <div className="support-page">
      ...
      <p className="support-subtitle">
        Kết nối trực tiếp với nhân viên Selene để được hỗ trợ.
      </p>
      <CustomerSupport />
    </div>
  );
