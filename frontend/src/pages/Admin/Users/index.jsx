    ...
    <>
      ...
      <div className="row g-3 mb-4">
        {[
          ...
          {
            label: "Bị khoá",
            value: users.filter((u) => u.status === "Bị khoá").length,
            icon: "bi-lock",
          },
        ].map((s) => (
          <div className="col-6 col-xl-3" key={s.label}>
            <div
              className="d-flex align-items-center gap-3 bg-white rounded-3 p-3"
            ...
            >
              ...
              <div>
                ...
                <div
                  style={{ fontSize: 22, fontWeight: 800, color: "#212529" }}
                >
                  {s.value}
                </div>
              </div>
                ...
                filtered.map((u, idx) => {
                  ...
                  return (
                    <tr key={u.id}>
                      ...
                      <td>
                        <span
                          className={`badge bg-${role.bg} bg-opacity-10 text-${role.bg} fw-semibold`}
                          style={{
                            fontSize: 12,
                            padding: "5px 10px",
                            borderRadius: 8,
                      ...
                      <td>
                        <span
                          className={`badge bg-${stBg} bg-opacity-10 text-${stBg} fw-semibold`}
                          style={{
                            fontSize: 12,
                            padding: "5px 10px",
                            borderRadius: 8,
                      ...
                      <td>
                        <div className="d-flex gap-1">
                          ...
                          >
                            <i
                              className={`bi ${u.status === "Hoạt động" ? "bi-lock" : "bi-unlock"}`}
                            />
                          </button>
                          <button
