...
export default function Footer() {
  return (
    <footer className="rb-footer">
      <div className="row g-4 pb-2 mx-5">
        <div className="col-12 col-lg-4">
          ...
          <p>
            ...
            <a href="tel:0984624532" className="rb-footer-link fw-bold">
              098 462 4532
            </a>
          </p>
          <p>
            <strong>Email:</strong>{" "}
            <a
              href="mailto:selenein2026@gmail.com"
              className="rb-footer-link fw-bold"
            >
              selenein2026@gmail.com
            </a>
          </p>
          <div className="rb-fsocial">
            <div className="rb-sbtnf">
      ...
      <div className="rb-fbottom mx-5" style={{ padding: "10px 0" }}>
        © Bản quyền thuộc về <strong>Selene Studio</strong> | Cung cấp bởi{" "}
